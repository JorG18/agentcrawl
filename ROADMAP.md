...
- Initial Phase 2 extraction quality baseline: 12 checked-in fixtures, fixture scoring threshold, JSON quality report, provenance metadata, Markdown structure metrics, and harder noisy docs/article/product/API-reference cases.
